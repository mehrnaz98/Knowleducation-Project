<template>
  ...
  >
    ...
    ></div>
    <div class="mt-[24rem] ml-4 flex flex-col items-start space-y-2">
      <div class="flex justify-start w-full space-x-2">
        <div class="bg-gray-200 w-[54%] h-7 rounded-full"></div>
        <div class="bg-gray-200 w-[24%] h-7 rounded-full"></div>
        <div class="bg-gray-200 w-[8%] h-7 rounded-full"></div>
      </div>
      <div class="flex justify-start w-full space-x-2">
        <div class="bg-gray-200 w-[24%] h-7 rounded-full"></div>
        <div class="bg-gray-200 w-[8%] h-7 rounded-full"></div>
